...
while True:
    ...
    for ship in me.get_ships():
        ...
        logging.info("This ship is: {}".format(ship_status[ship.id]))

        # For each of your ships, move randomly if the ship is on a low halite location or the ship is full.
        #   Else, collect halite.
        if (game_map[ship.position].halite_amount < constants.MAX_HALITE / 10 or ship.is_full) and ship_status[ship.id] == "exploring":
            # safe random movement
            next_move = findHigherHilate(ship.position)
    ...
    if game.turn_number <= 12 and me.halite_amount >= constants.SHIP_COST and not game_map[me.shipyard].is_occupied:
