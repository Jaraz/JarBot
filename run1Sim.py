...
#argum = ' --replay-directory replays/ -vvv --width 48 --height 48 "python MyBot.py" "python oldBot.py"'
...
argum = ' --replay-directory replays/ -vvv --width 64 --height 64 --seed 1543705806 "python MyBot.py" "python oldBot.py" '
