...
argum = ' --replay-directory replays/ --no-logs --no-replay  -vvv --width 8 --height 8 "python MyBot.py" "cd C:\\Users\\jaycw_000\\Documents\\GitHub\\JarBot\\v47\\ & python MyBot.py"'
