...
argum = ' --replay-directory replays/ --no-logs --no-replay  -vvv --width 16 --height 16 "python MyBot.py" "cd C:\\Users\\jaycw_000\\Documents\\GitHub\\JarBot\\v65\\ & python MyBot.py"'
